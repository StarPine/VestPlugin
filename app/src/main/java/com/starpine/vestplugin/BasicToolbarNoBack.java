 ...
 * @Version 1.0
 **/
public class Hegkge extends Toolbar implements View.OnClickListener {
    ...
    public Hegkge(Context context) {
        this(context, null);
    }

    public Hegkge(Context context, AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public Hegkge(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface ToolbarListener {
         ...
         * @param toolbar
         */
        void onBackClick(Hegkge toolbar);
    }
}