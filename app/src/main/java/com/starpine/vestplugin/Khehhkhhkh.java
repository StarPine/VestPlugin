 ...
 * @author wulei
 */
public class Khehhkhhkh extends Toolbar implements View.OnClickListener {
    ...
    public Khehhkhhkh(Context context) {
        this(context, null);
    }

    public Khehhkhhkh(Context context, AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public Khehhkhhkh(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static void setTitleText(Khehhkhhkh textView, String text) {
    ...
    public interface ToolbarListener {
         ...
         * @param toolbar
         */
        void onBackClick(Khehhkhhkh toolbar);
    }
}