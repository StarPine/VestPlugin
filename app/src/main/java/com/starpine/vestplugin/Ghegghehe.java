package com.starpine.vestplugin;
 ...
 * @Version 1.0
 **/
public class Ghegghehe extends Toolbar implements View.OnClickListener {
    ...
    public Ghegghehe(Context context) {
        this(context, null);
    }

    public Ghegghehe(Context context, AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public Ghegghehe(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Khehhkhhkh);
        title = a.getString(R.styleable.Khehhkhhkh_toolbar_title);
        titleColor = a.getColor(R.styleable.Khehhkhhkh_toolbar_title_color, context.getResources().getColor(R.color.toolbar_title_color));
        backImage = a.getResourceId(R.styleable.Khehhkhhkh_boolbar_back_image, R.drawable.ic_toolbar_back);
    }

    @BindingAdapter({"toolbar_title"})
    public static void setTitleText(com.dl.playfun.widget.BasicToolbar textView, String text) {
    ...
    public interface ToolbarListener {
         ...
         * @param toolbar
         */
        void onBackClick(Ghegghehe toolbar);
    }
}